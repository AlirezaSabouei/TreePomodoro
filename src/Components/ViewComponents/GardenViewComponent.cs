...
public class GardenViewComponent(
    ...
    IRequestHandler<AddSeedCommand, Garden> createTreeCommandHandler,
    IRequestHandler<UpdateTreeCommand, Garden> completeTreeCommandHandler,
